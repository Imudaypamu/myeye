                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.last_name')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.last_name" class="form-control" type="text"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.father_name')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.father_name" class="form-control" type="text" placeholder="Father Name"
                                        id="father_name">
                                </div>
                                @error('user.father_name') <div class="text-danger">{{ $message }}</div> @enderror
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.mother_name')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.mother_name" class="form-control" type="text"
                                        placeholder="Mother Name" id="mother_name">
                                </div>
                                @error('user.last_name') <div class="text-danger">{{ $message }}</div> @enderror
                            </div>
                        </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.alt_email')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.alt_email" class="form-control" type="email"
                                        placeholder="@example.com" id="alt_email">
                                </div>
                                @error('user.alt_email') <div class="text-danger">{{ $message }}</div> @enderror
                            </div>
                        </div> 
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.alt_mobile')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.alt_mobile" class="form-control" type="tel"
                                        placeholder="40770888444" id="alt_mobile">
                                </div>
                                @error('user.alt_mobile') <div class="text-danger">{{ $message }}</div> @enderror
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.aadhar_no')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.aadhar_no" class="form-control" type="tel"
                                        placeholder="4077 0888 0444" id="aadhar_no">
                                </div>
                                @error('user.aadhar_no') <div class="text-danger">{{ $message }}</div> @enderror
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.pan_no')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.pan_no" class="form-control" type="tel"
                                        placeholder="GMQ995W2D" id="pan_no">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.voter_id')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.voter_id" class="form-control" type="tel"
                                        placeholder="40770888444" id="voter_id">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.idf_moles')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.idf_moles" class="form-control" type="tel"
                                        placeholder="40770888444" id="idf_moles">
                                </div>
            ...
            <div class="card-body pt-4 p-3">
                ...
                @if ($showSuccesNotification)
                    <div wire:model="showSuccesNotification"
                        ...
                        <span class="alert-icon text-white"><i class="ni ni-like-2"></i></span>
                        <span
                            class="alert-text text-white">{{ __('Your Address information have been successfuly saved!') }}</span>
                        <button wire:click="$set('showSuccesNotification', false)" type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
                        </button>
                    </div>
                @endif
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.d_no')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.d_no" class="form-control" type="text" placeholder="D.No"
                                        id="d_no">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.landmark')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.landmark" class="form-control" type="text"
                                        placeholder="Land Mark" id="landmark">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.street')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.street" class="form-control" type="text" placeholder="Street"
                                        id="street">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.village')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.village" class="form-control" type="text"
                                        placeholder="Village" id="village">
                                </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.mandal')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.mandal" class="form-control" type="text"
                                        placeholder="Mandal" id="mandal">
                                </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.district')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.district" class="form-control" type="text"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.state')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.state" class="form-control" type="text"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.country')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.country" class="form-control" type="tel"
                    ...
                    <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.p_address')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.p_address" class="form-control" type="tel"
                                        placeholder="Permnent address" id="p_address">
                                </div>
            ...
            <div class="card-body pt-4 p-3">
                ...
                @if ($showSuccesNotification)
                    <div wire:model="showSuccesNotification"
                        ...
                        <span class="alert-icon text-white"><i class="ni ni-like-2"></i></span>
                        <span
                            class="alert-text text-white">{{ __('Your Education information have been successfuly saved!') }}</span>
                        <button wire:click="$set('showSuccesNotification', false)" type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
                        </button>
                    </div>
                @endif
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.school_name')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.school_name" class="form-control" type="text" placeholder="school_name"
                                        id="school_name">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.s_board')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.s_board" class="form-control" type="text"
                                        placeholder="ssc board" id="s_board">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.s_percentage')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.s_percentage" class="form-control" type="text" placeholder="Percentage"
                                        id="s_percentage">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.s_gpa')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.s_gpa" class="form-control" type="text"
                                        placeholder="s_gpa" id="s_gpa">
                                </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.s_location')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.s_location" class="form-control" type="text"
                                        placeholder="School Location" id="s_location">
                                </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.c_name')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.c_name" class="form-control" type="text"
                                        placeholder="c_name" id="c_name">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.c_board')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.c_board" class="form-control" type="text"
                                        placeholder="c_board" id="c_board">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.c_percentage')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.c_percentage" class="form-control" type="tel"
                                        placeholder="c_percentage" id="c_percentage">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.c_gpa')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.c_gpa" class="form-control" type="text" placeholder="D.No"
                                        id="c_gpa">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.c_location')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.c_location" class="form-control" type="text"
                                        placeholder="c_location" id="c_location">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.b_name')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.b_name" class="form-control" type="text" placeholder="b_name"
                                        id="b_name">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.b_board')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.b_board" class="form-control" type="text"
                                        placeholder="b_board" id="b_board">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.b_percentage')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.b_percentage" class="form-control" type="text" placeholder="b_percentage"
                                        id="b_percentage">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.b_gpa')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.b_gpa" class="form-control" type="text"
                                        placeholder="b_gpa" id="b_gpa">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.b_location')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.b_location" class="form-control" type="text"
                                        placeholder="b_location" id="b_location">
                                </div>
            ...
            <div class="card-body pt-4 p-3">
                ...
                @if ($showSuccesNotification)
                    <div wire:model="showSuccesNotification"
                        ...
                        <span class="alert-icon text-white"><i class="ni ni-like-2"></i></span>
                        <span
                            class="alert-text text-white">{{ __('Your Career information have been successfuly saved!') }}</span>
                        <button wire:click="$set('showSuccesNotification', false)" type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
                        </button>
                    </div>
                @endif
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.p1_name')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.p1_name" class="form-control" type="text" placeholder="Project Name"
                                        id="p1_name">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.p1_des')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.p1_des" class="form-control" type="text"
                                        placeholder="p1_des" id="p1_des">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.p1_due')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.p1_due" class="form-control" type="text" placeholder="Percentage"
                                        id="p1_due">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.p2_name')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.p2_name" class="form-control" type="text"
                                        placeholder="Project Name" id="p2_name">
                                </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.p2_des')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.p2_des" class="form-control" type="text"
                                        placeholder="Project Des" id="p2_des">
                                </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.p2_due')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.p2_due" class="form-control" type="text"
                                        placeholder="p2_due" id="p2_due">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.cu1_name')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.cu1_name" class="form-control" type="text"
                                        placeholder="cu1_name" id="cu1_name">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.cu1_des')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.cu1_des" class="form-control" type="tel"
                                        placeholder="cu1_des" id="cu1_des">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.cu1_due')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.cu1_due" class="form-control" type="text" placeholder="cu1_due"
                                        id="cu1_due">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.cu2_name')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.cu2_name" class="form-control" type="text"
                                        placeholder="cu2_name" id="cu2_name">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.cu2_des')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.cu2_des" class="form-control" type="text" placeholder="des"
                                        id="cu2_des">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="@error('user.cu2_due')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.cu2_due" class="form-control" type="text"
                                        placeholder="cu2_due" id="cu2_due">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.i1_name')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.i1_name" class="form-control" type="text" placeholder="i1_name"
                                        id="i1_name">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.i1_des')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.i1_des" class="form-control" type="text"
                                        placeholder="i1_des" id="i1_des">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.i1_due')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.i1_due" class="form-control" type="text"
                                        placeholder="i1_due" id="i1_due">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.i2_name')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.i2_name" class="form-control" type="text"
                                        placeholder="iu2_name" id="i2_name">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.i2_des')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.i2_des" class="form-control" type="text" placeholder="des"
                                        id="i2_des">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.i2_due')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.i2_due" class="form-control" type="text"
                                        placeholder="i2_due" id="i2_due">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.github')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.github" class="form-control" type="text" placeholder="Github"
                                        id="github">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.linkedin')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.linkedin" class="form-control" type="text"
                                        placeholder="Last Name" id="linkedin">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.portfolio')border border-danger rounded-3 @enderror">
                                    <input wire:model="user.portfolio" class="form-control" type="text" placeholder="Father Name"
                                        id="portfolio">
                                </div>
