<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
            ...
            <span class="ms-3 font-weight-bold">MyEye</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            <li class="nav-item pb-2">
                 <a class="nav-link {{ Route::currentRouteName() == 'dashboard' ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">All at Once</span>
                </a>
            </li>

            <li class="nav-item mt-2">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">updates</h6>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item mt-2">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Divisions</h6>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == 'education' ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Achievments</span>
                </a>
            </li>
            <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == 'links' ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Useful Links</span>
                </a>
            </li>
        </ul>
    </div>
    <div class="sidenav-footer mx-3 mt-3 pt-3">
        <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
            ...
            <div class="card-body text-left p-3 w-100">
                ...
                <div class="docs-info">
                    <h6 class="text-white up mb-0">Thanks For Using</h6>
                     
                    <p class="text-xs font-weight-bold">This Platform is built using Laravel Framework With High Security Configurations</p>
                    <a href="https://www.upilinks.in/payment-link/upi1174974581" target="_blank"
                        class="btn btn-white btn-sm w-100 mb-0">Donate Here</a>
                </div>
            </div>
        </div>
    </div>
